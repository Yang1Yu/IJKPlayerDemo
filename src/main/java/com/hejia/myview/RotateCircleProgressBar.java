...
public class RotateCircleProgressBar extends View {
    ...
    public RotateCircleProgressBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public RotateCircleProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        backCirclePaint.setMaskFilter(new BlurMaskFilter(20, BlurMaskFilter.Blur.OUTER));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawArc(
                // 设置初始位置
                new RectF(circlePadding * 2, circlePadding * 2,
                        getMeasuredWidth() - circlePadding * 2, getMeasuredHeight() - circlePadding * 2), -316, (float) (percent / 100.0) * 360, false, gradientCirclePaint);
